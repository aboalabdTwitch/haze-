...
class FriendsLayout : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        BUFriendsSearch.setOnClickListener {
            val intent= Intent(this, SearchForFriends::class.java)
            startActivity(intent)
        }
        BUFriendsRequested.setOnClickListener {
            val intent= Intent(this, RequestedFriends::class.java)
            startActivity(intent)
        }
